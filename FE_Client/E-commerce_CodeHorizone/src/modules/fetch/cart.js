...
const getUserCart = async (id, page) => {
  try {
    const params = {
      page,
    };
    const response = await axios.get(`/api/v1/users/${id}/carts`, { params });
...
module.exports = { getUserCart, createCart, updateCategory, deleteCart };
