  ...
  return (
    <>
      <ul class="flex-column space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
        <li>
          <a href="#" class="inline-flex items-center px-4 pe-20 py-3 text-white bg-blue-700 rounded-lg active w-full dark:bg-blue-600" aria-current="page">
        ...
        <li>
          <a class="inline-flex items-center px-4 py-3 rounded-lg bg-gray-300  text-medium text-gray-900 dark:text-gray-400 dark:bg-gray-800 w-full">
